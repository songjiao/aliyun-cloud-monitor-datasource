...
import AliyunCloudMonitorDatasource from '../src/datasource';
...
describe('ChangeMyNameDatasource', function() {
  ...
  beforeEach(function() {
    ...
    ctx.ds = new AliyunCloudMonitorDatasource(ctx.instanceSettings, ctx.backendSrv, ctx.templateSrv, ctx.$q);
  });
